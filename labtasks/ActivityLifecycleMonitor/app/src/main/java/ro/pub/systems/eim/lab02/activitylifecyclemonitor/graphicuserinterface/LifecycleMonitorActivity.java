...
import static ro.pub.systems.eim.lab02.activitylifecyclemonitor.general.Constants.REMEMBER_ME_CHECKBOX;
...
public class LifecycleMonitorActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            if (savedInstanceState.containsKey(USERNAME_EDIT_TEXT)){
                EditText usernameEditText = (EditText)findViewById(R.id.username_edit_text);
                usernameEditText.setText(savedInstanceState.get(USERNAME_EDIT_TEXT).toString());
            }
            if (savedInstanceState.containsKey(PASSWORD_EDIT_TEXT)){
                EditText passwordEditText = (EditText)findViewById(R.id.password_edit_text);
                passwordEditText.setText(savedInstanceState.get(PASSWORD_EDIT_TEXT).toString());
            }
            if (savedInstanceState.containsKey(REMEMBER_ME_CHECKBOX)){
                CheckBox checkBox = (CheckBox) findViewById(R.id.remember_me_checkbox);
                checkBox.setChecked(savedInstanceState.getBoolean(REMEMBER_ME_CHECKBOX));
            }
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        if (checkBox.isChecked()){
            outState.putString(USERNAME_EDIT_TEXT, usernameEditText.getText().toString());
            outState.putString(PASSWORD_EDIT_TEXT, passwordEditText.getText().toString());
            outState.putBoolean(REMEMBER_ME_CHECKBOX, checkBox.isChecked());
        }
    }
